...
def show_plot():
    ...
    print('''
                          ...
                          Your main mission is defeating the Space pirates boss stationed in Feniks system, but first you have to collect elements and weapon parts necesarry to build your gun.
